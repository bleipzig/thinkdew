	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="hemila-single-post margin-top-30">
			...
			<div class="blog-body">
				...
				<div class="entry-content"><?php echo esc_html(wp_trim_words( $post_content, 30, ''));?></div>
				<div class="blog-meta">
					<?php $categories = get_the_category(get_the_ID());?>
					<div class="category"><a href="<?php echo esc_url(get_category_link($categories[0]->term_id));?>"><?php echo esc_html($categories[0]->name); ?></a></div>
					<ul class="list">
