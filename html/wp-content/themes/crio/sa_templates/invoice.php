...
<html>
	...
	<body id="invoice" <?php body_class( 'si_default_theme' ); ?>>
							...
							<article class=" <?php echo esc_attr( $data['status_type'] ); ?>">
								...
								<?php if ( SI_Notifications::RECORD === $data['status_type'] ) : ?>
									<p>
										...
										<br/><a href="#TB_inline?width=600&height=380&inlineId=notification_message_<?php echo (int) $item_id ?>" id="show_notification_tb_link_<?php echo (int) $item_id ?>" class="thickbox si_tooltip notification_message" title="<?php esc_html_e( 'View Message', 'crio' ) ?>"><?php esc_html_e( 'View Message', 'crio' ) ?></a>
									</p>
		...
		<div id="footer_credit">
			...
			<!--<p><?php esc_attr_e( 'Powered by Sprout Invoices', 'crio' ) ?></p>-->
