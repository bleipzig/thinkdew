...
HTML;
	...
	public function customizer_reorganization( $wp_customize ) {
		...
		if ( $wp_customize->get_section( 'static_front_page' ) ) {
			...
			$section->description = '<div class="bgtfw-description"><p>' . esc_html__( 'Change your site\'s Homepage settings', 'crio' ) . '</p><div class="help"><a href="https://www.boldgrid.com/support/boldgrid-crio/changing-the-page-layout-in-boldgrid-crio/" target="_blank"><span class="dashicons"></span>Help</a></div></div>';
			$section->priority    = 5;
	...
	public function add_menu_description( $wp_customize ) {
		...
		foreach ( $menus as $menu ) {
			...
			if ( $section ) {
				$section->description = '<a target="_blank" class="boldgrid-icon-newtab dashicons-before dashicons-external" href="https://www.boldgrid.com/support/working-with-menus-in-boldgrid/">' . __( 'Menu Tutorial', 'crio' ) . '</a>';
			}
		}
	}
