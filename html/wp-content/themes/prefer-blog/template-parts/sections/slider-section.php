<?php 
/**
 * Prefer Blog Slider Function
 * @since Prefer Blog 1.0.0
 *
 * @param null
 * @return void
 *
            ...
            <div class="col-md-5">
              <div class="caption">
                    ...
                    <div class="entry-meta">
                            ...
                            <span><?php esc_html_e('By', 'prefer-blog'); ?></span>
                    ...
                    <div class="post-excerpt entry-content">
                      <?php the_excerpt(); ?>
                      <a class="more-btn" href="<?php the_permalink(); ?>"><?php _e('Read More', 'prefer-blog'); ?></a>
                    </div>
              </div>
            </div>
